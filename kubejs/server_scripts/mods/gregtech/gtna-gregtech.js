ServerEvents.recipes(e => {
    ...
    greg.assembler('gtna:gtceu/assembler/mega_ebf')
        ...
        .duration(200000)
        .EUt(GTValues.V[GTValues.HV])
    greg.canner('gtna:gtceu/canning/fuel_rods/thorium')
        .itemInputs('kubejs:nuclear_fuel_rod', 'gtnn:enriched_thorium')
        .itemOutputs('create_new_age:nuclear_fuel')
        .duration(120)
        .EUt(GTValues.V[GTValues.LV])
    greg.canner('gtna:gtceu/canning/fuel_rods/uranium')
        .itemInputs('kubejs:nuclear_fuel_rod', 'gtnn:enriched_uranium')
        .itemOutputs('kubejs:nuclear_fuel_uranium')
        .duration(120)
        .EUt(GTValues.V[GTValues.LV])
    greg.canner('gtna:gtceu/canning/fuel_rods/plutonium')
        .itemInputs('kubejs:nuclear_fuel_rod', 'gtnn:enriched_plutonium')
        .itemOutputs('kubejs:nuclear_fuel_plutonium')
        .duration(120)
        .EUt(GTValues.V[GTValues.LV])
