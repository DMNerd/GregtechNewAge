ServerEvents.recipes(e => {
	...
	beeBreeding('productivebees:diamond', 'productivebees:chromium', 'productivebees:platinum')
	beeBreeding('productivebees:titanium', 'productivebees:ruby', 'productivebees:chromium')
	...
	beeBreeding('gtnabees:lutetium', 'productivebees:chromium', 'gtnabees:americium')
	...
	beeBreeding('productivebees:yellow_black_carpenter_bee', 'productivebees:green_carpenter_bee', 'productivebees:lumber_bee')
	beeBreeding('gtnabees:eldritch', 'productivebees:quarry', 'productivebees:sculk')
