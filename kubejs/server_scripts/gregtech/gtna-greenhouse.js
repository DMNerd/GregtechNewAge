ServerEvents.recipes((e) => {
  ...
  function greenhousetreerecipe(woodType){
      greg
    ...
    function greenhousefruittreerecipe(woodType){
      greg
        .greenhouse(woodType[0])
        .notConsumable(woodType[0])
        .inputFluids("water 1000")
    ...
    function greenhouseplantrecipe(seedType){
      greg
    ...
    function greenhouseoreberryrecipe(ore){
      greg
      .greenhouse('oreberriesreplanted:' + ore[0] + '_oreberry_bush')
    ...
    greg
      .greenhouse('oreberriesreplanted:' + ore[0] + '_oreberry_bush_fertilised')
      .notConsumable('oreberriesreplanted:' + ore[0] + '_oreberry_bush')
      .itemInputs("4x gtceu:fertilizer")
      .inputFluids("distilled_water 1000")
      .itemOutputs(
    ...
    function oreberry_crossbreed(parent, parent2, result, fluid){
      greg
        .greenhouse('oreberry_crosbreeding/' + result)
    ...
    trees.forEach((woodType) => {
      greenhousetreerecipe(woodType)
    });
    fruit_trees.forEach((woodType) => {
      greenhousefruittreerecipe(woodType)
    });
    plants.forEach((seedType) => {
      greenhouseplantrecipe(seedType)
    });   
    oreberries.forEach((ore) => {
      greenhouseoreberryrecipe(ore)
    });
    oreberry_crossbreed('lead_oreberry_bush', 'nickel_oreberry_bush', 'osmium_oreberry_bush', Fluid.of('gtceu:osmium', 1500))
